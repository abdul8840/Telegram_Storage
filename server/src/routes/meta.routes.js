  ...
  asyncHandler(async (req, res) => {
    ...
    res.json({
      media: {
        ...
        transcodePreset: config.media.transcodePreset,
        transcodeCrf: config.media.transcodeCrf,
        transcodeMaxDimension: config.media.transcodeMaxDimension,
        maxConcurrentTranscodes: config.media.maxConcurrentTranscodes,
